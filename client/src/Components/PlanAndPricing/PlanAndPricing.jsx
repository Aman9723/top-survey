			...
			<Box>
				...
				<Box className={styles.MinNavBar2}>
					<Box className={styles.insideMinNavbar2} width={"30%"} gap={"20px"}>
						...
						<Box margin={"auto"} width={"80%"}>
							<Text display={"flex"} gap={"5px"}>
								...
								<Text marginTop={"24px"} color={"gray"} fontWeight={"bold"}>
									/user / month
								</Text>{" "}
							</Text>
							<Text>Starting at 3 users, billed annually</Text>
						</Box>
						<Button background={"#007faa"} className={styles.Selectbtn}>
							SELECT
						</Button>
						<Box>
							<ul>
					...
					<Box className={styles.insideMinNavbar2} width={"30%"}>
						...
						<Button bg={"#671e75"} className={styles.Selectbtn}>
							SELECT
						</Button>
						<Box>
							<ul>
					...
					<Box className={styles.insideMinNavbar2} width={"30%"}>
						...
						<Button bg={"#05467e"} className={styles.Selectbtn}>
							SELECT
						</Button>
						<Box>
							<ul>
