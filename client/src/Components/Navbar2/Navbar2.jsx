import { Box, Button, Drawer, DrawerCloseButton, DrawerContent, DrawerOverlay, Flex, Image,  Link, Menu, MenuButton, MenuItem, MenuList, Text, useDisclosure } from '@chakra-ui/react'
        ...
        <Box className={styles.Navbar2box}>
          ...
          <Image height={'40px'} src={logo}></Image>
           ...
           <Box className={styles.Nav_Second}>
            ...
            <Box>
            <Menu>
                <MenuButton border={"none"}  marginLeft={'90px'} backgroundColor={'#3f3b33'}  height={'30px'}  color={'white'} _hover={'none'} _focus={'none'} as={Button} rightIcon={<ChevronDownIcon />}>
                    {/* {username} */} {"mehataishan8282@gmail.com"}
                </MenuButton>
                <MenuList background={"whiteAlpha.100"} marginLeft={'60px'} fontWeight={"500"}>
                    <MenuItem className={styles.butnav4} fontWeight={"500"}>My Account</MenuItem>
                    <MenuItem className={styles.butnav4} fontWeight={"500"}>Library</MenuItem>
                    <MenuItem className={styles.butnav4} fontWeight={"500"}>Contact</MenuItem>
                    <MenuItem className={styles.butnav4} fontWeight={"500"} onClick={handleSignout}>Sign Out</MenuItem>
                </MenuList>
                </Menu>
            </Box>
           </Box>
...
function Grid() {
    ...
    return (
      <>
        <Button border={"none"} backgroundColor={'#3f3b33'} _hover={'#3f3b33'} ref={btnRef} colorScheme='teal' onClick={onOpen}>
        <Link>
