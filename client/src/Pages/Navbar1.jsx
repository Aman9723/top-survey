		...
		<Box>
			...
			>
				...
				<Box display="flex" gap="1.5rem">
								...
								<Box width="250px">
									...
									<Box>
										<MenuItem display="row">
											<Box color="#007fb2" fontWeight="bold" marginTop="8px">
												<h6>Top Survey</h6>
											</Box>
								...
								<Box width="250px">
									...
									<Box>
										<MenuItem display="row">
											...
											<Box fontSize="14px" marginTop="4px">
												{" "}
												<p>Understand & improve customer experience (NPS)</p>
											</Box>
										</MenuItem>
									</Box>
									<Box>
								...
								<Box width="250px">
									...
									<Box marginTop="22px">
										<MenuItem display="row">
											...
											<Box fontSize="14px" marginTop="4px">
												{" "}
												<p>Create marketing content from customer feedback</p>
											</Box>
										</MenuItem>
									</Box>
									<Box>
										<MenuItem display="row">
											...
											<Box fontSize="14px" marginTop="4px">
												{" "}
												<p>Collect,review & manage application online</p>
											</Box>
										</MenuItem>
									</Box>
									<Box>
										<MenuItem display="row">
											...
											<Box fontSize="14px" marginTop="4px">
												{" "}
												<p>Gather data & payments with online forms</p>
											</Box>
										</MenuItem>
									</Box>
									<Box>
								...
								<Box width="250px">
									<Box>
										<MenuItem display="row">
											...
											<Box fontSize="14px" marginTop="4px">
												{" "}
												<p>Best practices for using surveys & surveys data</p>
											</Box>
										</MenuItem>
									</Box>
								</Box>
								...
								<Box width="250px">
									<Box>
										<MenuItem display="row">
											...
											<Box fontSize="14px" marginTop="4px">
												{" "}
												<p>Tutorials & how-to guides for using Top Survey</p>
											</Box>
										</MenuItem>
									</Box>
								</Box>
					...
					<Button _hover="none" backgroundColor="white">
						Plans & Prices
					</Button>
				</Box>
				<Box display="flex" gap="5px">
					<Button _hover="none" backgroundColor="white" onClick={handleLogin}>
						Log in
					</Button>

					<Button backgroundColor="#f9be00" onClick={handleSignup}>
						Sign up free
					</Button>
				</Box>
			</div>
