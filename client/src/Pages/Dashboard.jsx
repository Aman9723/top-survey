import { Accordion, AccordionButton, AccordionIcon, AccordionItem,  AccordionPanel,  Box, Button,Image,  Link,  Text } from '@chakra-ui/react';
     ...
     <Navbar2/>
        ...
        <Box>
          ...
          <AccordionItem className={styles.accordion1}>
            <h2>
              <AccordionButton>
                <Box padding={"10px"} flex='1' textAlign='left' _hover={{textDecoration:"none"}} display={'flex'}>
                <Text color={'#00b159'} marginTop={"0px"} fontWeight={'500'} >Quick survey</Text>: Which of these tools do you use at least once a month?  (Select all that apply)
                </Box>
                <AccordionIcon />
              </AccordionButton>
            </h2>
        ...
        <Box backgroundColor={'#f7f8fa'} padding={'30px'}>
         ...
         <Text className={styles.get_start}>Let's get started & create your first survey!</Text>
          <Button border={"none"} _hover={'none'} backgroundColor={'#00b159 '} padding={"10px"} className={styles.create_but}>CREATE SURVEY</Button>
         </Box>
