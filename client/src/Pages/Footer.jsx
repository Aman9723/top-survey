		...
		<div>
			<Box marginTop={"50px"}>
				...
				<Select
					...
					placeholder="English"
				>
					<option value="option1">Dansk</option>
					<hr />
					...
					<hr />
					<option value="option3">Francis</option>
					<hr />
					<option value="option3">English(UK)</option>
					<hr />
					<option value="option3">Italino</option>
					<hr />
			...
			<Box width={"35%"} marginLeft={"20px"} marginTop={"20px"}>
				<Text>
					Top Survey is brought to you by momentive.ai. Shape what's next with
			...
			>
				<Text marginLeft={"20px"}>Copyright © smooth-dock-1057 2022</Text>
				<Image
					height={"100px"}
					src="https://i.im.ge/2022/07/22/FqzgX8.png"
				></Image>
			</Box>
		</div>
	);
