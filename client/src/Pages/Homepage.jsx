    ...
    <div>
      ...
      <Box marginTop="70px">
        ...
        <Box className={styles.adigetbutton}>
          <Button _hover={{ backgroundColor: "#00ce78" }}>Get Started</Button>
        </Box>
        <Box marginTop={"200px"}>
      ...
      <Box className={styles.tool_kit}>
        <Box className={styles.small_1}>
          ...
          <Text className={styles.tool_text}>Customer support</Text>
          <Text className={styles.tool_text2}>
        ...
        <Box className={styles.small_1}>
          ...
          <Text className={styles.tool_text}>Human resources</Text>
          <Text className={styles.tool_text2}>
        ...
        <Box className={styles.small_1}>
          ...
          <Text className={styles.tool_text}>Product management</Text>
          <Text className={styles.tool_text2}>
            Build products that drive impact and offer a strong product-market
            fit.
          </Text>
          <Box className={styles.link_1}>
            <Link>Learn more</Link>
      ...
      <Box className={styles.kit_box}>
        <Box className={styles.kit_box1}>
          <Box className={styles.link_1}>
            <Link>Demand generation manager</Link>
          </Box>
          <Box className={styles.link_1}>
            <Link>Brand marketer</Link>
          </Box>
        </Box>

        <Box className={styles.kit_box1}>
          <Box className={styles.link_1}>
            <Link>Diversity, equity & inclusion</Link>
          </Box>
          <Box className={styles.link_1}>
            <Link>User researcher</Link>
          </Box>
        </Box>

        <Box className={styles.kit_box1}>
          <Box className={styles.link_1}>
            <Link>Product marketer</Link>
          </Box>
          <Box className={styles.link_1}>
            <Link>CRM admin</Link>
          </Box>
      ...
      <Box backgroundColor={"#f7f8fa"}>
        ...
        <Box className={styles.feedback}>
          <Box className={styles.feedback1}>
            ...
            <Box marginTop={"30px"}>
              <Text className={styles.plan_works}>Momentive Solutions</Text>
            </Box>
            <Text className={styles.tool_text2}>
              Get a platform that can grow and change along with your survey
          ...
          <Box className={styles.feedback1}>
            ...
            <Box marginTop={"30px"}>
              <Text className={styles.plan_works}>GetFeedback</Text>
            </Box>
            <Text className={styles.tool_text2}>
              Manage your company’s data with advanced security and control, so
              you can enable your teams to share and collaborate safely.
            </Text>
            <Box marginTop={"30px"} textAlign="center">
              <button
                style={{
      ...
      {/* Still curious? */}
      <Box marginTop={"100px"}>
        <Text className={styles.plan_works}>Still curious?</Text>
      </Box>
      <Box marginTop={"20px"}>
      ...
      <Box className={styles.tool_kit}>
        <Box className={styles.small_1}>
          ...
          <Text className={styles.tool_text}>Success Stories</Text>
          <Text className={styles.tool_text2}>
            Read about our customers, explore our webinars, and get guides on
            collecting feedback in your industry.
          </Text>
          <Box className={styles.link_1}>
            <Link>Explore resources</Link>
          </Box>
        </Box>
        <Box className={styles.small_1}>
          <Image src="https://prod.smassets.net/assets/cms/sm/uploads//blog-tile-card.png"></Image>
          <Text className={styles.tool_text}>Blog</Text>
          <Text className={styles.tool_text2}>
            Get tips on how to create better surveys, hear the latest product
            news, or check out our signature research.
          </Text>
          <Box className={styles.link_1}>
            <Link>See Curiosity at Work</Link>
          </Box>
        </Box>
        <Box className={styles.small_1}>
          <Image src="https://prod.smassets.net/assets/cms/sm/uploads//help-center-tile.png"></Image>
          <Text className={styles.tool_text}>Help Center</Text>
          <Text className={styles.tool_text2}>
            Access tutorials on how features work, learn more about billing,
      ...
      <Box className={styles.Net_p}>
        <Text>
          ...
          NPS-related emoticons are registered <br /> trademarks of Bain &
